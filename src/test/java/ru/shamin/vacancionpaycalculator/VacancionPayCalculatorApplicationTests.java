package ru.shamin.vacancionpaycalculator;
...
@SpringBootTest
class VacancionPayCalculatorApplicationTests {
    ...
    void testCalculate(int averageSalary, int vacationDays, double vacationPay){
        ...
        Assertions.assertEquals(vacationPay, calculatorService.calculateVacationPay(averageSalary,vacationDays));
    }
